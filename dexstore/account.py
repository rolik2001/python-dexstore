...
class Account(GrapheneAccount):
    """ This class allows to easily access Account data
        ...
        :rtype: dictionary
        :raises dexstore.exceptions.AccountDoesNotExistsException: if account
                does not exist
    ...
    def call_positions(self):
        """ Alias for :func:dexstore.account.Account.callpositions
        """
...
class AccountUpdate(GrapheneAccountUpdate):
    """ This purpose of this class is to keep track of account updates
        as they are pushed through by :class:`dexstore.notify.Notify`.
