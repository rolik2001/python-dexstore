...
from dexstorebase.asset_permissions import (
    asset_permissions,
    force_flag,
    test_permissions,
    todict,
...
class Asset(GrapheneAsset):
    ...
    def seize(self, from_account, to_account, amount):
        """ Seize amount from an account and send to another
            ...
            :param dexstore.account.Account from_account: From this account
            :param dexstore.account.Account to_account: To this account
            :param dexstore.amount.Amount amount: Amount to seize
        """
    ...
    def set_market_fee(self, percentage_fee, max_market_fee):
        """ Set trading percentage fee
            ...
            :param dexstore.amount.Amount max_market_fee: Max Fee
