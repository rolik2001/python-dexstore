import unittest
import mock
from dexstore.message import Message
...
class Testcases(unittest.TestCase):
    ...
    def test_sign_message(self):
        p = Message("message foobar", blockchain_instance=dexstore).sign(account="init0")
        Message(p, blockchain_instance=dexstore).verify()
    ...
    def test_verify_message(self):
        Message(
            ...
            "-----BEGIN META-----\n"
            "account=init0\n"
            "memokey=DST6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV\n"
            "block=23814223\n"
